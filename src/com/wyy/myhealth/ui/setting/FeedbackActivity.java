...
public class FeedbackActivity extends SubmitActivity implements ActivityInterface{
	...
	protected void submitMsg() {
		...
		HealthHttpClient.doHttpFeedBack(WyyApplication.getInfo().getId(), contentstr, contactstr,
				mHandler);
